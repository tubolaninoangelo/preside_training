...
<cfoutput>
	...
	<cfloop array="#values#" index="i" item="selectValue">
		...
		<div class="radio">
			<input type="radio" id="#inputId#_#i#" name="#inputName#" value="#HtmlEditFormat( selectValue )#" class="#inputClass# #extraClasses#" tabindex="#getNextTabIndex()#" <cfif checked>checked</cfif>>
